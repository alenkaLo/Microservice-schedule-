...
namespace TimeTable.Controllers
{
    ...
    {   
        ...
        [HttpPut("{id:guid}")]
        public JsonResult Update(Guid id, Guid subjectId, Guid userId, string className, DateTime startTime, DateTime endtime)
        {
            var result = _lessonService.Update(id, subjectId, userId, className, startTime, endtime);
            if (result == null)
                return new JsonResult(NotFound());
