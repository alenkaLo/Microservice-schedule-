...
namespace TimeTable.Services
{
    ...
    {
        Task<List<Lesson>> GetAllLessons(TimeOnly startTime, TimeOnly endTime, DateOnly startDate, DateOnly endDate);
        ...
        Task<List<Lesson>> GetClassSchedule(string className);
    }
}
